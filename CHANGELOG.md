...
## [v99.9.0](https://github.com/kubeflow/trainer/releases/tag/v99.9.0) (2026-02-25)

This is Kubeflow Trainer v99.9.0 release.

```bash
kubectl apply --server-side -k "https://github.com/kubeflow/trainer.git/manifests/overlays/manager?ref=v99.9.0"
kubectl apply --server-side -k "https://github.com/kubeflow/trainer.git/manifests/overlays/runtimes?ref=v99.9.0"
```

You can now install controller manager with Helm charts 🚀

```bash
helm install kubeflow-trainer oci://ghcr.io/kubeflow/charts/kubeflow-trainer --version 99.9.0
```
